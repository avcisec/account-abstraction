...
import {Transaction,MemoryTransactionHelper, BOOTLOADER_FORMAL_ADDRESS} from "lib/foundry-era-contracts/src/system-contracts/contracts/libraries/MemoryTransactionHelper.sol";
...
contract zkMinimalAccountTest is Test {
    ...
    function testZkOwnerCanExecuteCommands() public {
        ...
        Transaction memory transaction = _createUnsignedTransaction(minimalAccount.owner(), 0x71, dest, value,functionData);
        // Act 
    ...
    function _createUnsignedTransaction(address from, uint8 transactionType, address to, uint256 value, bytes memory data) internal view returns(Transaction memory) {
        ...
        return Transaction({
            ...
            gasLimit: 16777266,
            gasPerPubdataByteLimit: 16777266,
            maxFeePerGas: 16777266,
            maxPriorityFeePerGas: 16777266,
            paymaster: 0,
            nonce: nonce,
            value: value,
